...
if("FALSE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/kate/catkin_ws/src/openslam_gmapping-master)
  set(openslam_gmapping_DEVEL_PREFIX /home/kate/catkin_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/kate/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kate/catkin_ws/install/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
