...
KeyControlLaser::KeyControlLaser()
{
	char key;
	int x = 0;
	int y = 0;
...
{
    ros::init(argc, argv, "kates_key_with_laser");
    KeyControlLaser key_control_laser;
